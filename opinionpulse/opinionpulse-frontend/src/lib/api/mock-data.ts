...
export function buildMockSearchResponse(query: string): SearchResponse {
  ...
  return {
    ...
    sentiment_forecast: [
      { date: "Day 1", predicted_score: 0.1, sentiment: "neutral", estimated_volume: 1200 },
      { date: "Day 2", predicted_score: 0.2, sentiment: "positive", estimated_volume: 1300 },
      { date: "Day 3", predicted_score: 0.35, sentiment: "positive", estimated_volume: 1400 },
      { date: "Day 4", predicted_score: 0.42, sentiment: "positive", estimated_volume: 1500 },
      { date: "Day 5", predicted_score: 0.5, sentiment: "positive", estimated_volume: 1600 },
      { date: "Day 6", predicted_score: 0.48, sentiment: "positive", estimated_volume: 1700 },
      { date: "Day 7", predicted_score: 0.55, sentiment: "positive", estimated_volume: 1800 },
    ],
