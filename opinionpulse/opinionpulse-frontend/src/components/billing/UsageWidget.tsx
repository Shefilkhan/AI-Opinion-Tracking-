...
function UsageWidgetSkeleton() {
  return (
    <div className="rounded-[var(--dash-radius)] bg-[var(--dash-surface-alt)] p-3.5">
...
export function UsageWidget() {
  ...
  return (
    <div className="mb-3 rounded-[var(--dash-radius)] bg-[#1e1b4b] p-3.5 text-white dark:bg-[#12141c] dark:ring-1 dark:ring-white/10">
      ...
      {usage.plan.id === "starter" && (
        <Link
          to="/pricing"
          className={cn(
            "flex w-full items-center justify-center rounded-[var(--dash-radius-sm)]",
            "bg-white px-2 py-2 text-[12px] font-semibold text-[#1e1b4b] no-underline",
