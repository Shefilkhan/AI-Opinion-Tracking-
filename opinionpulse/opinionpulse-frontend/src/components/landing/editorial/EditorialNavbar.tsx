...
import { EditorialMobileMenu } from "@/components/landing/editorial/EditorialMobileMenu"
...
export function EditorialNavbar() {
  ...
  return (
    ...
    >
      <div className="le-container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:hidden">
          <button
            ...
            className="inline-flex size-10 items-center justify-center rounded-full border border-[var(--le-border)] bg-[var(--le-surface)] text-[var(--le-text)]"
      ...
      <EditorialMobileMenu open={open} onOpenChange={setOpen} />
    </header>
  )
}
