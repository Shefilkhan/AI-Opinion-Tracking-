        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          {techStackItems.map((item, i) => (
            <ScrollReveal key={item.name} delay={i * 40}>
              <div
                className="flex items-center gap-2 rounded-xl border border-border bg-card px-5 py-2.5 shadow-sm transition-all duration-200 ease-out hover:scale-[1.04] hover:border-primary/30 hover:bg-primary/5"
              >
                <span
